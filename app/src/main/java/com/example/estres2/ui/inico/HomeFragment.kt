    ...
    private fun setCardView() {
        val cards = listOf(
                CardView(R.drawable.ic_stress,
                        "ESTRÉS",
                        "Es una reacción del cuerpo que se manifiesta ante ciertos estímulos, sobretodo cuando nos sometemos a altos niveles de presión; lo cual puede desatar una serie de respuestas tanto psicológicas como fisiológicas. Las consecuencias derivadas de un episodio de estrés se caracterizan por la aparición de alteraciones como fatiga, ansiedad, insomnio, trastornos digestivos, etc."),
                CardView(R.drawable.ic_ppg,
                        "FOTOPLETISMOGRAFÍA",
                        "El principio físico de la Fotopletismografía (PPG por sus siglas en inglés) está basado en determinar las propiedades ópticas de un área determinada de piel. Para esto, se emite luz infrarroja sobre la piel, la cual es absorbida en mayor o menor cantidad dependiendo de la cantidad del flujo sanguíneo. La luz emitida es reflejada y ésta corresponde con la variación del volúmen de sangre."),
